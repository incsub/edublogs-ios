...
- (UITableViewCell *)tableView:(UITableView *)tv cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	switch (indexPath.row) {
		case 0:
			cell.textLabel.text = NSLocalizedString(@"Start a new blog at Edublogs", @"");
			break;
		case 1:
			cell.textLabel.text = NSLocalizedString(@"Add blog hosted at Edublogs", @"");
			break;
		case 2:
			cell.textLabel.text = NSLocalizedString(@"Add Edublogs Campus Site", @"");
			break;
		default:
			break;
	}
...
- (void)tableView:(UITableView *)tv didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	if(indexPath.row == 0) { // Start a new blog at Edublogs
	...
	else if(indexPath.row == 1) { // Add blog hosted at Edublogs
