...
- (void)viewDidLoad {
    ...
    messageLabel.text = NSLocalizedString(@"It looks like Edublogs for iOS crashed the last time you used it. You can help us resolve the issue by sending a crash report.", @"");
...
- (IBAction)yes:(id)sender {
	...
	if(crashData != nil) {
		...
		if (report == nil) {
			...
			NSString *subject = [NSString stringWithFormat:@"Edublogs %@ Crash Report", 
								 [[NSBundle mainBundle] objectForInfoDictionaryKey:@"CFBundleVersion"]];
			[controller setMailComposeDelegate:self];
			[controller setToRecipients:[NSArray arrayWithObject:@"crashreport@edublogs.org"]];
