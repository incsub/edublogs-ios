...
/*        NSString *path = [[NSBundle mainBundle] bundlePath];
        ...
        baseURL:baseURL 
        //[NSURL URLWithString:@"http://edublogs.org"]
*/
        [self.webView loadHTMLString:self.detailHTML baseURL:[NSURL URLWithString:@"http://edublogs.org"]];     
    }
}
...
- (NSString*) getDocumentPermalink {
    ...
    if ( permaLink == nil || [[permaLink trim] isEqualToString:@""]) {
        ...
        //make sure we are not sharing URL like this: http://en.edublogs.org/reader/mobile/?v=post-16841252-1828
        if ([permaLink rangeOfString:@"edublogs.org/reader/mobile/"].location != NSNotFound) { 
