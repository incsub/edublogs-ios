...
#define kAppStoreURL			@"http://itunes.apple.com/us/app/edublogs/id526466328?mt=8"
#define kNotificationAuthURL	@"http://edublogs.org/xmlrpc.php"

#define kMobileReaderFakeLoaderURL		@"http://edublogs.org/reader/mobile/v2/loader"
#define kMobileReaderURL		@"http://edublogs.org/reader/mobile/v2/?chrome=no"
#define kMobileReaderFPURL		@"http://edublogs.org/reader/mobile/v2/freshly-pressed"
#define kMobileReaderDetailURL  @"http://edublogs.org/wp-admin/admin-ajax.php?action=wpcom_load_mobile&template=details&v=2"
#define kMobileReaderTopicsURL  @"http://edublogs.org/reader/mobile/v2/?template=topics"
#define kHybridTokenSetting     @"WPWebAppHybridAuthToken"
#define kAuthorizedHybridHost   @"edublogs.org"

#define kStatsEndpointURL		@"https://stats.edublogs.org/api/1.0/"
